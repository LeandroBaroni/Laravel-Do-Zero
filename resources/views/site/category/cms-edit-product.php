    ...
    <body>
        ...
        <section class="cms__container main-wrapper">
            ...
            <section class="cms__container__content">
                <div class="split__container">
                    ...
                    <div class="input__group input__group__disabled">
                        ...
                        <span class="input__group__icon__right"><img src="../../../../../../OneDrive/Área%20de%20Trabalho/interface-laravel-do-zero-main/interface-laravel-do-zero-main/public/images/check-icon-disabled-input-file.svg" alt=""></span>
                    </div>
                </div>
            ...
            <footer class="cms__container__footer flex-container">
                <div>
                    <a href="javascript:;" class="button button_primary" role="button">Salvar altações</a>
                    <a href="../../../../../../OneDrive/Área%20de%20Trabalho/interface-laravel-do-zero-main/interface-laravel-do-zero-main/public/cms-home.php" class="button button_secondary" role="button">Cancelar</a>
                </div>
                <div>
