    ...
    <section class="cms__container main-wrapper">
        <header class="cms__container__header">
            <ul class="cms__container__header__tabs">
                ...
                <li><a href="{{route('site.new_blog')}}">Gerenciar blog</a></li>
            </ul>
        </header>
        <section class="cms__container__content">
            ...
            <section class="cms__grid__items">
                ...
                <a href="../category/cms-edit-category.php" class="item__of__grid">
                    ...
                    <button class="item__vetical__menu dropdown">
                        ...
                        <div class="dropdown__content">
                            ...
                            <p><img src="../../../../../../OneDrive/Área%20de%20Trabalho/interface-laravel-do-zero-main/interface-laravel-do-zero-main/public/images/delete-icon.svg" alt="">Excluir categoria</p>
                        </div>
                    </button>
                </a>
                ...
                <a href="../category/cms-new-category.php" class="button add_new button_large" role="button">Adicionar nova
                    categoria</a>
            </section>
    ...
    <section class="cms__container main-wrapper">
        ...
        <section class="cms__container__content cms__blog__grid">
            ...
            <section class="cms__grid__items">
                ...
                <a href="../../../../../../OneDrive/Área%20de%20Trabalho/interface-laravel-do-zero-main/interface-laravel-do-zero-main/public/cms-new-post.php" class="button add_new button_large" role="button">Adicionar novo Post</a>

                <a href="../../../../../../OneDrive/Área%20de%20Trabalho/interface-laravel-do-zero-main/interface-laravel-do-zero-main/public/cms-edit-post.php" class="item__of__grid button_large">
                    ...
                    <button class="item__vetical__menu dropdown">
                        ...
                        <div class="dropdown__content">
                            ...
                            <p><img src="../../../../../../OneDrive/Área%20de%20Trabalho/interface-laravel-do-zero-main/interface-laravel-do-zero-main/public/images/delete-icon.svg" alt="">Excluir postagem</p>
                        </div>
                    </button>
                </a>
